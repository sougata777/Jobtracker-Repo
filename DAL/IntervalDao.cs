...
namespace JobTracker.DAL
{
    public class IntervalDao
    {
        public string GetIntervals()
        {
            ...
            string intervals = (string)cacheManager.GetData("IntervalsXML");

            if (null == intervals)
            {
                intervals = string.Empty;
                ...
                using (conn)
                {
                    ...
                    cmd.CommandText = "GetIntervalsXML";
                    ...
                    intervals = sb.ToString();

                    reader.Close();

                    cacheManager.Add("IntervalsXML", intervals);
                }
            }
