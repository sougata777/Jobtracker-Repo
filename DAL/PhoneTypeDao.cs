...
namespace JobTracker.DAL
{
    public class PhoneTypeDao
    {
        public string GetPhoneTypes()
        {
            ...
            string phoneTypes = (string)cacheManager.GetData("PhoneTypesXML");

            if (null == phoneTypes)
            {
                phoneTypes = string.Empty;
                ...
                using (conn)
                {
                    ...
                    cmd.CommandText = "GetPhoneTypesXML";
                    ...
                    phoneTypes = sb.ToString();

                    reader.Close();

                    cacheManager.Add("PhoneTypesXML", phoneTypes);
                }
            }
