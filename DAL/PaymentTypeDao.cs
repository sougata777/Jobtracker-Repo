...
namespace JobTracker.DAL
{
    public class PaymentTypeDao
    {
        public string GetPaymentTypes()
        {
            ...
            string paymentTypes = (string)cacheManager.GetData("PaymentTypesXML");

            if (null == paymentTypes)
            {
                paymentTypes = string.Empty;
                ...
                using (conn)
                {
                    ...
                    cmd.CommandText = "GetPaymentTypesXML";
                    ...
                    paymentTypes = sb.ToString();

                    reader.Close();

                    cacheManager.Add("PaymentTypesXML", paymentTypes);
                }
            }
