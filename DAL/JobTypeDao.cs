...
namespace JobTracker.DAL
{
    public class JobTypeDao
    {
        public string GetJobTypes()
        {
            ...
            string jobTypes = (string)cacheManager.GetData("JobTypesXML");

            if (null == jobTypes)
            {
                jobTypes = string.Empty;
                ...
                using (conn)
                {
                    ...
                    cmd.CommandText = "GetJobTypesXML";
                    ...
                    jobTypes = sb.ToString();

                    reader.Close();

                    cacheManager.Add("JobTypesXML", jobTypes);
                }
            }
