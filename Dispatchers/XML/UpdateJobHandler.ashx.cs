...
namespace JobTracker.Dispatchers.XML
{
    ...
    /// updates a job.
    /// </summary>
    public class UpdateJobHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.Write(UpdateJob(jobID, jobNumber, dispatchNumber, serialNumber, salesCheckNumber, projectNumber, PONumber, serviceOrderNumber, installDate, jobStatusID, technician, note, installFrom, installTo));
        }

        private string UpdateJob(string jobID, string jobNumber, string dispatchNumber, string serialNumber, string salesCheckNumber, string projectNumber, string PONumber, string serviceOrderNumber, string installDate, string jobStatusID, string technician, string note, string installFrom, string installTo)
        {
            try
            {
                new JobDao().UpdateJob(jobID, jobNumber, dispatchNumber, serialNumber, salesCheckNumber, projectNumber, PONumber, serviceOrderNumber, installDate, jobStatusID, technician, note, installFrom, installTo);
