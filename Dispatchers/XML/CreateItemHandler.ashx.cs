...
namespace JobTracker.Dispatchers.XML
{
    ...
    /// Creates an item.
    /// </summary>
    public class CreateItemHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.Write(CreateItem(invoiceID, itemNumber, sku, description, qty, amount));
        }

        private string CreateItem(string invoiceID, string itemNumber, string sku, string description, string qty, string amount)
        {
            try
            {
                new ItemDao().CreateItem(invoiceID, itemNumber, sku, description, qty, amount);
