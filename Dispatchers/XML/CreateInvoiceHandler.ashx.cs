...
namespace JobTracker.Dispatchers.XML
{
    ...
    /// Creates an invoice.
    /// </summary>
    public class CreateInvoiceHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            context.Response.Write(CreateInvoice(jobID, invoiceNumber, paymentStatusID, paymentTypeID));
        }

        private string CreateInvoice(string jobID, string invoiceNumber, string paymentStatusID, string paymentTypeID)
        {
            try
            {
                new InvoiceDao().CreateInvoice(jobID, invoiceNumber, paymentStatusID, paymentTypeID);
