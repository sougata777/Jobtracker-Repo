...
namespace JobTracker.Dispatchers.XML
{
    ...
    /// Updates a customer.
    /// </summary>
    public class UpdateCustomerHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string jobTypeID = context.Request.Form["JobTypeID"] ?? string.Empty;
            jobTypeID = HttpUtility.UrlDecode(jobTypeID);

            context.Response.Write(UpdateCustomer(customerID, firstName, lastName, company, address1, address2, city, state, zip, addressTypeID, phone1, phone2, phone3, phoneTypeID1, phoneTypeID2, phoneTypeID3, jobTypeID));
        }

        private string UpdateCustomer(string customerID, string firstName, string lastName, string company, string address1, string address2, string city, string state, string zip, string addressTypeID,
                                        string phone1, string phone2, string phone3, string phoneTypeID1, string phoneTypeID2, string phoneTypeID3, string jobTypeID)
        {
            try
            {
                new CustomerDao().UpdateCustomer(customerID, firstName, lastName, company, address1, address2, city, state, zip, addressTypeID, phone1, phone2, phone3, phoneTypeID1, phoneTypeID2, phoneTypeID3, jobTypeID);
