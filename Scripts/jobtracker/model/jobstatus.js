...
Ext.define('jobtracker.model.jobstatus', {
    extend: 'Ext.data.Model',
    fields: ['JobStatusName', 'JobStatusID']
});

Ext.define('jobtracker.store.jobstatusstore', {
    extend: 'Ext.data.Store',
    autoLoad: false,
    model: 'jobtracker.model.jobstatus',
    proxy: {
        type: 'ajax',
        url: 'Dispatchers/XML/GetJobStatusHandler.ashx',
        reader: {
            type: 'xml',
            record: 'JobStatus'
        }
