...
Ext.define('jobtracker.model.jobtype', {
    extend: 'Ext.data.Model',
    fields: ['JobTypeName', 'JobTypeID']
});

Ext.define('jobtracker.store.jobtypestore', {
    extend: 'Ext.data.Store',
    autoLoad: false,
    model: 'jobtracker.model.jobtype',
    proxy: {
        type: 'ajax',
        url: 'Dispatchers/XML/GetJobTypesHandler.ashx',
        reader: {
            type: 'xml',
            record: 'JobType'
        }
