...
Ext.define('jobtracker.model.phonetype', {
    extend: 'Ext.data.Model',
    fields: ['PhoneTypeName', 'PhoneTypeID']
});

Ext.define('jobtracker.store.phonetypestore', {
    extend: 'Ext.data.Store',
    autoLoad: false,
    model: 'jobtracker.model.phonetype',
    proxy: {
        type: 'ajax',
        url: 'Dispatchers/XML/GetPhoneTypesHandler.ashx',
        reader: {
            type: 'xml',
            record: 'PhoneType'
        }
