...
Ext.define('jobtracker.model.paymentstatus', {
    extend: 'Ext.data.Model',
    fields: ['PaymentStatusName', 'PaymentStatusID']
});


Ext.define('jobtracker.store.paymentstatusstore', {
    extend: 'Ext.data.Store',
    autoLoad: false,
    model: 'jobtracker.model.paymentstatus',
    proxy: {
        type: 'ajax',
        url: 'Dispatchers/XML/GetPaymentStatusHandler.ashx',
        reader: {
            type: 'xml',
